...
namespace com.burningthumb
{
	public class SecurePlayerPrefs {
	   ...
	   */
		private static readonly string PRIVATE_KEY_PREFIX = "plm";
		private static readonly string PRIVATE_KEY_RAND = "don";
		private static readonly string PRIVATE_KEY_SUFFIX = "za";
		...
		private static readonly string RAND_KEY = "plmdonza";
